...
WALLET_ROOT=$$PWD/moneda

CONFIG += c++11

# cleaning "auto-generated" bitmoneda directory on "make distclean"
...
linux {
   ...
   #     }
    ...
    # currently moneda has an issue with "static" build and linunwind-dev,
...
TRANSLATIONS =  \ # English is default language, no explicit translation file
                $$PWD/translations/moneda-core.ts \ # translation source (copy this file when creating a new translation)
                $$PWD/translations/moneda-core_ar.ts \ # Arabic
                $$PWD/translations/moneda-core_pt-br.ts \ # Portuguese (Brazil)
                $$PWD/translations/moneda-core_de.ts \ # German
                $$PWD/translations/moneda-core_eo.ts \ # Esperanto
                $$PWD/translations/moneda-core_es.ts \ # Spanish
                $$PWD/translations/moneda-core_fi.ts \ # Finnish
                $$PWD/translations/moneda-core_fr.ts \ # French
                $$PWD/translations/moneda-core_hr.ts \ # Croatian
                $$PWD/translations/moneda-core_id.ts \ # Indonesian
                $$PWD/translations/moneda-core_hi.ts \ # Hindi
                $$PWD/translations/moneda-core_it.ts \ # Italian
                $$PWD/translations/moneda-core_ja.ts \ # Japanese
                $$PWD/translations/moneda-core_nl.ts \ # Dutch
                $$PWD/translations/moneda-core_pl.ts \ # Polish
                $$PWD/translations/moneda-core_ru.ts \ # Russian
                $$PWD/translations/moneda-core_sv.ts \ # Swedish
                $$PWD/translations/moneda-core_zh-cn.ts \ # Chinese (Simplified-China)
                $$PWD/translations/moneda-core_zh-tw.ts \ # Chinese (Traditional-Taiwan)
                $$PWD/translations/moneda-core_he.ts \ # Hebrew
                $$PWD/translations/moneda-core_ko.ts \ # Korean
                $$PWD/translations/moneda-core_ro.ts \ # Romanian
                $$PWD/translations/moneda-core_da.ts \ # Danish
                $$PWD/translations/moneda-core_cs.ts \ # Czech
                $$PWD/translations/moneda-core_sk.ts \ # Slovak
                $$PWD/translations/moneda-core_ar.ts \ # Arabic
...
android{
    deploy.commands += make install INSTALL_ROOT=$$DESTDIR && androiddeployqt --input android-libmoneda-wallet-gui.so-deployment-settings.json --output $$DESTDIR --deployment bundled --android-platform android-21 --jdk /usr/lib/jvm/java-8-openjdk-amd64 -qmldir=$$PWD
}
...
DISTFILES += \
    notes.txt \
    moneda/src/wallet/CMakeLists.txt \
    components/MobileHeader.qml


# windows application icon
RC_FILE = moneda-core.rc
