...
AddressBook::AddressBook(Moneda::AddressBook *abImpl,QObject *parent)
...
QList<Moneda::AddressBookRow*> AddressBook::getAll(bool update) const
{
    qDebug(__FUNCTION__);
...
Moneda::AddressBookRow * AddressBook::getRow(int index) const
{
