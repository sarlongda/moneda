...
public:
    enum Direction {
        Direction_In  =  Moneda::TransactionInfo::Direction_In,
        Direction_Out =  Moneda::TransactionInfo::Direction_Out,
...
private:
    explicit TransactionInfo(Moneda::TransactionInfo * pimpl, QObject *parent = 0);
private:
    friend class TransactionHistory;
    Moneda::TransactionInfo * m_pimpl;
