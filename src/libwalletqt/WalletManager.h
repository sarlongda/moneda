...
public:
    enum LogLevel {
        LogLevel_Silent = Moneda::WalletManagerFactory::LogLevel_Silent,
        LogLevel_0 = Moneda::WalletManagerFactory::LogLevel_0,
        LogLevel_1 = Moneda::WalletManagerFactory::LogLevel_1,
        LogLevel_2 = Moneda::WalletManagerFactory::LogLevel_2,
        LogLevel_3 = Moneda::WalletManagerFactory::LogLevel_3,
        LogLevel_4 = Moneda::WalletManagerFactory::LogLevel_4,
        LogLevel_Min = Moneda::WalletManagerFactory::LogLevel_Min,
        LogLevel_Max = Moneda::WalletManagerFactory::LogLevel_Max,
    };
