...
#include "wallet/api/wallet2_api.h" // we need to have an access to the Moneda::Wallet::Status enum here;
...
public:
    ...
    enum Status {
        Status_Ok       = Moneda::Wallet::Status_Ok,
        Status_Error    = Moneda::Wallet::Status_Error,
        Status_Critical = Moneda::Wallet::Status_Critical
    };

    Q_ENUM(Status)

    enum ConnectionStatus {
        ConnectionStatus_Connected       = Moneda::Wallet::ConnectionStatus_Connected,
        ConnectionStatus_Disconnected    = Moneda::Wallet::ConnectionStatus_Disconnected,
        ConnectionStatus_WrongVersion    = Moneda::Wallet::ConnectionStatus_WrongVersion
    };
...
private:
    ...
    Wallet(Moneda::Wallet *w, QObject * parent = 0);
    ~Wallet();
private:
